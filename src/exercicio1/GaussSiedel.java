...
public class GaussSiedel {
     ...
     */
    public static double[] executarGSiedel(int n, double[][] A, double[] b, double tol, int maxIter) {
        ...
        System.out.println("Método de Gauss-Seidel não convergiu após " + maxIter + " iterações.");
        return x;
